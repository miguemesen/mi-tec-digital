...
public class App  {
    ...
    public static Long[] bubbleSort(List<Long> intList) {

        Long[] a = new Long[intList.size()];
        a = intList.toArray(a);
    ...
    public static Long[] orderThis(EstudianteService estudianteService){
        List<Long> list=new ArrayList<Long>();
        for(Estudiante estudiante : estudianteService.getAll()) {
            list.add(estudiante.getCarne());
        }
    ...
    public static void showAllStudents(EstudianteService estudianteService) {
        Long[] studentsInOrder =  orderThis(estudianteService);
        System.out.println("\n\n");
        ...
        for(Long carne:studentsInOrder){
            System.out.println(estudianteService.getById(carne).getCarne() + "\t\t" + estudianteService.getById(carne).getNombre() + "\t\t" +estudianteService.getById(carne).getApellido() + "\t\t"+ estudianteService.getById(carne).getEdad());
        }
